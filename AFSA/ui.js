...
function startExec() {
  ...
  trytimes = parseInt(document.getElementById("trytimes").value);
  visual = parseFloat(document.getElementById("visual").value);
  ...
  afsaObj = new AFSA(p,population,iterations,trytimes,visual,step,xu,xl,activeFunction);
  afsaObj.exec(historyUpdate);
